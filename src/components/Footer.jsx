...
const Footer = () => {
  ...
  return (
    <footer className="text-white" style={{ background: 'linear-gradient(180deg, #1e293b 0%, #0f172a 50%, #1e3a5f 100%)' }}>
      {/* Main Footer */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Het leukste Tennis & Padel zomerkamp van Oostvoorne. 6 t/m 12 jaar. Juli 2026.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/media" className="text-gray-400 hover:text-sky-400 transition-colors text-sm">
                  Foto&apos;s
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-gray-400 text-sm">
                ...
                <span>
                  Tvo Oostvoorne<br />
                  Zomerkamp Tennis & Padel
                </span>
              </li>
              <li className="flex items-center gap-3 text-gray-400 text-sm">
                <Mail className="h-4 w-4 text-amber-400 flex-shrink-0" />
                <a href="mailto:info@tennisconnect.nl" className="hover:text-amber-400 transition-colors">
